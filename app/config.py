...
CONTAINER_USER_ID = os.getenv("CONTAINER_USER_ID", "1000")

# Submission settings
SUBMISSIONS_MAX_PER_USER = int(os.getenv("SUBMISSIONS_MAX_PER_USER", "50"))
SUBMISSIONS_QUEUE_LIMIT_PER_USER = int(os.getenv("SUBMISSIONS_QUEUE_LIMIT_PER_USER", "1"))
...
QUEUE_CLEANUP_INTERVAL_SEC = int(os.getenv("QUEUE_CLEANUP_INTERVAL_SEC", "3600"))

# Other
DISABLE_STATUS_ROUTE_LOGS = int(os.getenv("DISABLE_STATUS_ROUTE_LOGS", "1"))